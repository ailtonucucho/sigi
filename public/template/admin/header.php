				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown app-dropdown">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="profile.php"><?=  $langArray["Profile"]?></a>
							<a class="dropdown-item" href="logout.php"><?= $langArray["Logout"] ?></a>
						</div>
					</li>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="index.php"> <?= $langArray["Login"] ?> </a></li>
									<li><a href="register.php"> <?= $langArray["Register"] ?> </a></li>
