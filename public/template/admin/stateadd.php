            ...
            <div class="page-wrapper">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">Add Bairro</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
								...
								<form method="post" id="insert product" enctype="multipart/form-data">
									<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<h5 class="card-title">Bairro Details</h5>
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">Bairro Name</label>
														<div class="col-lg-9">
				...
				<div class="row">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Bairro List</h4>
